...
ここでは流行順や性能比較ではなく、用意できる教師信号で並べます。手法名より先に見るのは、モデルへ何を渡して、どの振る舞いを増やしたいのかです。
...
良い応答を出す確率を上げる、という考え方です。ただし、言語モデルを報酬だけで動かすと、報酬を稼ぐために変な応答を出すことがあります。そこで、元のモデルから離れすぎないように KL (Kullback-Leibler) 正則化を入れることが多いです。
