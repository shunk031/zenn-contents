...
事後学習は、何を教師信号として使うかの設計です。模範応答、選好、報酬、検証結果、追加情報を見た自己分布のどれを使うかで、必要なデータ、訓練の構成、得意なタスクが変わります。新しい手法を読むときも、まず「何を教師信号としてモデルに戻しているのか」を見ると、SFT、RLHF、DPO、RLVR、GRPO、OPD、OPSD、SDPO の関係を追いやすくなります。
